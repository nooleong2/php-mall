...
<html lang="en">
  <head>
    ...
    <script src="./js/stipulation.js" defer></script>
  </head>
  <body>
    
    <main class="m-5 p-5 border rounded-5">
        <!-- 약관 -->
        ...
        <!-- 회원가입 페이지 바로가기 방지 -->
        <form action="./register.php" method="POST" name="stipulation_form" style="display: none;">
